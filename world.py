...
def create_floor(_level):
    ...
    if _level == 4:
        first_room = room.room_boss_4
        liste_level = [room.room_4_1, room.room_4_2, room.room_4_3, room.room_4_4, room.room_4_5, room.room_4_6, room.room_4_7, room.room_4_8, room.room_4_9, room.room_4_10, room.room_4_11]
