...
def create_floor(_level):
    ...
    if _level == 1:
        first_room = room.room_2_1
        liste_level = [room.room_2_0, room.room_2_1, room.room_2_2, room.room_2_0, room.room_2_0, room.room_2_0, room.room_2_0, room.room_2_0, room.room_2_0, room.room_2_0,]
