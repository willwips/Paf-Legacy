...
accueil_1 = pygame.transform.scale(pygame.image.load('picture/ui/ecran_dacceuil_.png').convert_alpha(),
                                   [pygame.display.get_surface().get_size()[0],
                                    pygame.display.get_surface().get_size()[1]])
accueil_2 = pygame.transform.scale(pygame.image.load('picture/ui/ecran_dacceuil_2.png').convert_alpha(),
                                   [pygame.display.get_surface().get_size()[0],
                                    pygame.display.get_surface().get_size()[1]])
death_screen = pygame.transform.scale(pygame.image.load('picture/ui/Death_screen .png').convert_alpha(),
                                      [pygame.display.get_surface().get_size()[0],
                                       pygame.display.get_surface().get_size()[1]])
win_screen = pygame.transform.scale(pygame.image.load('picture/ui/credits.png').convert_alpha(),
                                    [pygame.display.get_surface().get_size()[0],
                                     pygame.display.get_surface().get_size()[1]])
